...
{"node1","node1.dirkcoin.org"},
{"node2","node2.dirkcoin.org"},
{"node3","node3.dirkcoin.org"},
{"node4","node4.dirkcoin.org"},
{"node5","node5.dirkcoin.org"},
{"node6","node6.dirkcoin.org"},
{"node7","node7.dirkcoin.org"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DirkCoin is probably already running."), addrBind.ToString().c_str());
        else
