...
uint256 hashGenesisBlock("0x2480288b0f4af86306bb7908b792772dcfd65a4edcf1d5a584142e3b5ad20a66");
...
const string strMessageMagic = "DirkCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if (nHeight <= 100 ) {
        nSubsidy = 1*COIN;
    } else if (nHeight <= 172900 ) {
        nSubsidy = 20*COIN;
    } else if (nHeight <= 345700 ) {
        nSubsidy = 10*COIN;
    } else if (nHeight <= 518500 ) {
        nSubsidy = 5*COIN;
    } else {
        nSubsidy = 2*COIN;
    }
...
static const int64 nTargetTimespan = 60 * 60; // DirkCoin: 1 days
static const int64 nTargetSpacing = 30; // DirkCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal dirkcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DirkCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xed36b117a1530dec854cc9b3623011ef3d4cec8befedb72255513c96810439b5");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "the dirkcoin, the world!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388163981; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0xe920151fe16a8e01fd0e4d459c6226c4e32aaaa6ae5a773c773107064a21ccf2"));
